    ...
    def move_rewards(self):
        ...
        for temp in self.rewards:
            ...
            if temp['reward'] > 0:
                ...
                continue
            elif count == 1 and self.counter%random.choice([1,2,3])==0:
                temp['coords'] = self.move_const(temp)
            elif count == 2 and self.counter%random.choice([1,2,3])==0:
                temp['coords'] = self.move_const(temp)
            elif count == 3 and self.counter%random.choice([1,2,3])==0:
                temp['coords'] = self.move_const(temp)
